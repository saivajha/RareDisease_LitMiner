...
# Streamlit UI
st.set_page_config(page_title="Scientific Literature Miner", layout="wide")
st.title("🔬 Scientific Literature Miner")
st.markdown("""Search PubMed for Scientific and biomedical literature. View abstracts, journals, and publication years. 🧠""")

query = st.text_input("Enter a disease research area or biomedical keyword", "Fragile X Syndrome")
